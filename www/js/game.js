...
var timerStart = 10; //timer start number
...
var resultTitleText = '\n MY SCORE '; //text for result page title
...
function goPage(page){
	...
	switch(page){
		...
		case 'result':
			...
			stopGame();
			$("#stage3").addClass("resultbg");
				 $("#stage2").removeClass("ansbg");

			 if(0<= playerData.score && playerData.score <=5){
startAnimateButton(replayButton);

document.getElementById('prize12').style.display="block";
			 }
			else if(6<= playerData.score && playerData.score <=10){

				startAnimateButton(replayButton);

document.getElementById('prize9').style.display="block";
			}else if(11<= playerData.score && playerData.score <=14){

				startAnimateButton(replayButton);

document.getElementById('prize2').style.display="block";
			}else if(15<= playerData.score && playerData.score <=19){

				startAnimateButton(replayButton);

document.getElementById('prize6').style.display="block";
			}else if(20<= playerData.score && playerData.score <=24){

				startAnimateButton(replayButton);

document.getElementById('prize11').style.display="block";
			}else if(24<= playerData.score && playerData.score <=28){

				startAnimateButton(replayButton);

document.getElementById('prize10').style.display="block";
			}else if(29<= playerData.score && playerData.score <=36){

				startAnimateButton(replayButton);

document.getElementById('prize4').style.display="block";
			}else if(37<= playerData.score && playerData.score <=38){

				startAnimateButton(replayButton);

document.getElementById('prize11').style.display="block";
			}else if(39<= playerData.score && playerData.score <=44){

				startAnimateButton(replayButton);

document.getElementById('prize14').style.display="block";
			}else if(45<= playerData.score && playerData.score <=46){

				startAnimateButton(replayButton);

document.getElementById('prize2').style.display="block";
			}else if(47<= playerData.score && playerData.score <=50){
 ...
 */
 function startGame(){	
 	document.getElementById('prize12').style.display="none";
 	document.getElementById('prize11').style.display="none";
 	document.getElementById('prize10').style.display="none";
 	document.getElementById('prize9').style.display="none";
 	document.getElementById('prize8').style.display="none";
 	document.getElementById('prize7').style.display="none";
 	document.getElementById('prize6').style.display="none";
 	document.getElementById('prize5').style.display="none";
 	document.getElementById('prize4').style.display="none";
document.getElementById('prize3').style.display="none";
