...
//startimage.width = "200px";
//startimage.height = "70px";
//startimage.style.width="500px";
//startimage.style.height="30px";
     startButton = new createjs.Bitmap(startimage);
...
startButton.scaleY=1.1;
	...
	//startButton.textAlign = "right";
	startButton.textBaseline='alphabetic';
	startButton.x = canvasW/1.3;
	...
	resultDescTxt.font = "30px bariol_regularregular";
	...
	resultScoreTxt.font = "80px bariol_regularregular";
